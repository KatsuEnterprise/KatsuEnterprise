...
namespace PuntajesJueces.Gráfica.Loggin
{
    ...
    public partial class LogginJueces : Form
    {
        ...
        public int IdTorneoSeleccionado { get; set; }
        public int NumJuez { get; set; }
        ...
        public void SetIdTorneoSeleccionado(int idTorneoSeleccionado)
        { IdTorneoSeleccionado = idTorneoSeleccionado; }
        ...
        private void LogginJueces_Load(object sender, EventArgs e)
        {
